<!-- Modal -->
<div class='modal fade' id='exampleModalCenter_resetpass_<?php echo $reset_target_id; ?>'>
        ...
        <div class='modal-content'>
            ...
            <div class='modal-footer'>
                ...
                <form method='POST' action='<?php echo $reset_page; ?>.php' style='display: inline;'>
                    ...
                    <input type='hidden' name='reset_user_id' value='<?php echo (int)$reset_target_id; ?>'>
                    <button type='submit' name='reset_user_password' class='btn btn-primary'>Reset Password</button>
                </form>
            </div>
        </div>
    </div>
