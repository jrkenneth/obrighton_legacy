<!-- Modal -->
<div class='modal fade' id='exampleModalCenter_resetpass_tenant_<?php echo $reset_target_id; ?>'>
        ...
        <div class='modal-content'>
            ...
            <div class='modal-footer'>
                ...
                <form method='POST' action='<?php echo $reset_page; ?>.php' style='display: inline;'>
                    ...
                    <input type='hidden' name='reset_tenant_id' value='<?php echo (int)$reset_target_id; ?>'>
                    <button type='submit' name='reset_tenant_password' class='btn btn-primary'>Reset Password</button>
                </form>
            </div>
        </div>
    </div>
