								...
								<div class="table-responsive active-projects style-1 dt-filter exports" style="min-height: 400px;">
									...
									<table id="customer-tbl" class="table shorting">
										...
										<tbody>
											<?php
												if($tu_role_id == "2"){
													$retrieve_role_assignees = "select * from access_mgt where user_role='".$tu_role."' and user_id='".$this_user."' and target='agent'";
													$rra_result = $con->query($retrieve_role_assignees);
													while($row = $rra_result->fetch_assoc())
													{
														$_target_id=$row['target_id'];

														$retrieve_all_agents = "select * from users where id='".$_target_id."'";
														...
														while($row = $raa_result->fetch_assoc())
														{
															...
															if($_dashboard_access == "0"){
																...
																$_status_action = "<a type='button' ".$editor_hidden." data-bs-toggle='modal' data-bs-target='#exampleModalCenter_suspend_".$_id."' class='dropdown-item'>Suspend Agent</a>";
																...
																$_status_action = "<a type='button' ".$editor_hidden." data-bs-toggle='modal' data-bs-target='#exampleModalCenter_activate_".$_id."' class='dropdown-item'>Activate Agent</a>";
															}
																	...
																	<td>
																		<div class='dropdown ms-auto text-end'>
																			...
																			<div class='dropdown-menu dropdown-menu-end'>
																				<a class='dropdown-item' href='view-details.php?id=".$_id."&view_target=users&source=manage-agents'>View Details</a>
																				".$_status_action."
																				<a class='dropdown-item' ".$editor_hidden." href='?target=update-user&id=".$_id."'>Edit Agent</a>
																				<a class='dropdown-item' ".$editor_hidden." href='access-management.php?id=".$_id."'>Manage Access</a>
																				<a type='button' ".$editor_hidden." data-bs-toggle='modal' data-bs-target='#exampleModalCenter_".$_id."' class='dropdown-item'>Delete Agent</a>
																			</div>
																		</div>
																	</td>
																</tr>
															...
															$delete_target = "Delete Agent: ".$_first_name." ".$_last_name;
															...
															$delete_target_param = "";
															$delete_page = "manage-agents";
					
															$suspension_target_id = $_id;
															$suspension_target = "Agent: ".$_first_name." ".$_last_name;
															...
															$suspension_page = "manage-agents";
					
															$activation_target_id = $_id;
															$activation_target = "Agent: ".$_first_name." ".$_last_name;
													...
													while($row = $raa_result->fetch_assoc())
													{
														...
														if($_dashboard_access == "0"){
															...
															$_status = "<span class='badge badge-success light border-0'><i class='fas fa-check'></i></span>";
															$_status_action = "<a type='button' data-bs-toggle='modal' data-bs-target='#exampleModalCenter_suspend_".$_id."' class='dropdown-item'>Suspend Agent</a>";
														}elseif($_dashboard_access == "2"){
															$_status = "<span class='badge badge-danger light border-0'><i class='fas fa-exclamation-triangle'></i></span>";
															$_status_action = "<a type='button' data-bs-toggle='modal' data-bs-target='#exampleModalCenter_activate_".$_id."' class='dropdown-item'>Activate Agent</a>";
														}
																...
																<td>
																	<div class='dropdown ms-auto text-end'>
																		...
																		<div class='dropdown-menu dropdown-menu-end'>
																			<a class='dropdown-item' href='view-details.php?id=".$_id."&view_target=users&source=manage-agents'>View Details</a>
																			".$_status_action."
																			<a class='dropdown-item' href='?target=update-user&id=".$_id."'>Edit Agent</a>
																			<a class='dropdown-item' href='access-management.php?id=".$_id."'>Manage Access</a>
																			<a type='button' data-bs-toggle='modal' data-bs-target='#exampleModalCenter_".$_id."' class='dropdown-item'>Delete Agent</a>
																		</div>
																	</div>
																</td>
															</tr>
...
<?php
	include("_include/modals/add-agent-modal-form.php");
