...
<?php
    if($thispage == "notifications"){
        $retrieve_recent_notifications = "select * from notifications WHERE `for`='landlords' and `target_id`='".$this_landlord."' order by date desc"; 
        $margin_bottom = "";
?>
...
<?php
        ...
        $retrieve_recent_notifications = "select * from notifications WHERE `for`='landlords' and `target_id`='".$this_landlord."' order by date desc limit 0,6"; 
