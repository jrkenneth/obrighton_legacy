                ...
                <li class=" user_setting">
                  <div class="dropdown">
                    <a class="btn" href="#" data-bs-toggle="dropdown">
                      <img src="../file_uploads/landlords/<?php echo $tu_profile_picture; ?>" style="width: 50px; border-radius: 50%; height: 50px; border: 3px solid lightgrey;" alt="<?php echo $tu_first_name." ".$tu_last_name; ?>"> 
                    </a>
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="properties.php" class="items-center"><i class="flaticon-home mr15"></i>All Properties</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="tenants.php" class="items-center"><i class="flaticon-user mr15"></i>All Tenants</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="payment-history.php" class="items-center"><i class="flaticon-clock mr15"></i>Payment History</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="pending-payments.php" class="items-center"><i class="flaticon-investment mr15"></i>Expected Payments</a>
          </div>
          <hr>
          <div class="sidebar_list_item ">
